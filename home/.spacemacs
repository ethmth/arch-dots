...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(lsp-mode lsp-grammarly)
...
before packages are loaded."
  ...
  ;; lsp-grammarly configuration
  (with-eval-after-load 'lsp-mode
    (push '(grammarly
            "https://api.grammarly.com/v1"
            (lambda ()
              `(:initialize-params
                (:access-token ,(read-passwd "Grammarly Access Token: ")))))
          lsp-server-registry))
